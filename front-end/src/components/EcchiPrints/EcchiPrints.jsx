...
const backgrounds = Array.from({ length: 10 }, (_, i) => ({
  ...
  color: ["#FFD700", "#4682B4", "#FF6347", "#32CD32", "#9370DB", "#FF69B4", "#20B2AA", "#F4A460", "#778899", "#DC143C"][
    i
  ],
}))
...
export default function EcchiPrints() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-8 flex justify-center">
        <button
          className="py-2 px-8 border-2 rounded-full underline border-black text-xl font-bold uppercase hover:bg-gray-100"
